---
title: "Inspect Different Length Sample Size impact on ISS 2.2"
author: "Brett Stacy"
...
# Data Generated With:
C:/Users/bstacy2/OneDrive - UW/UW Postdoc/GitHub Repos/baseISS/run/run_ISS_0.6.3(and.4).R
...
out.20 = readRDS("C:/Users/bstacy2/OneDrive - UW/UW Postdoc/GitHub Repos/baseISS_data/outputs/haul_sample_size_change_V2.5_N_samples_20_ISS_100iters_output_2024-09-24.RDS")
...
# 30
(out.20$length$iss$iss/out.N$length$iss$iss) %>% round(digits = 2) %>% 
  plot(type = "l")
(out.20$length$iss$iss/out.N$length$iss$iss) %>% round(digits = 2) %>% mean
