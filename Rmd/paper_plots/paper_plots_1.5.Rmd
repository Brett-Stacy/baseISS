...
par(mfrow = c(1,1))
plot(out_1.5$length$iss$YEAR, out_1.5$length$iss$iss, type = "o", pch = 19, ylab = "ISSB", ylim = c(0, 15000), cex.lab = 1.3) 
...
text(1977, 14000, "A", cex = 1.5)



plot(out_1.5$length$iss$YEAR, out_1.5$length$iss$nss, type = "l", ylab = "Nominal Sample Size", xaxt = "n", cex.lab = 1.5, cex.axis = 1.3)
text(1977, 420000, "B", cex = 1.5)


plot(out_5.2$length$iss$YEAR[sub_range], out_5.2$length$iss$iss[sub_range], ylab = "ISSB", cex.lab = 1.5, col = "cyan", ylim = c(0, 27000), xlab = "", xaxt = "n", lwd = 1.5, type = "o", pch= 18, cex.axis = 1.3)
...
par(mfrow = c(1,1))
plot(out_37.2$length$iss$YEAR, out_37.2$length$iss$iss, col = "blue", type = "l")
