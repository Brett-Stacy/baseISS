...
paper_scenario_1.4 - Same as 1.3 except with minimum_sample size effecting nhls etc. and save data frame functionality to facilitate samples/haul plot for paper (version as at scenario 25.1)
...
paper_scenario_5.2 - Same as 1.2 except with new version (as at scenario 25.1) and 500 iters
