# initiate improved weighting factor customizability - chose any combination of NULL, haul_numbers, month_numbers for EBS Pcod.


run_name = "weighting_factor_custom_V1"
