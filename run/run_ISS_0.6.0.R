# Change sample size option - Try again. 0.5._ versions did not work.
# This change is a re-attempt at 0.5, but subsample outside of boot_length this time.

run_name = "haul_sample_size_change_V2.1"
