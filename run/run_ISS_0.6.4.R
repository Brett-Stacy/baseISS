# Change sample size option - same as previous version but only fixed 20


run_name = "haul_sample_size_change_V2.5"
...
saveRDS(.output, file = paste0("C:/Users/bstacy2/OneDrive - UW/UW Postdoc/GitHub Repos/baseISS_data/outputs/", run_name, "_N_samples_", samples, "_ISS_", iters, "iters_output_", Sys.Date(), ".RDS"))
